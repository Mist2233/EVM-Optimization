...
def main_benchmark_from_csv():
    ...
    max_transactions_to_process = 10  # <<<< 用户: 调整此值以处理更多/更少的交易
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            # 针对第一个交易调用的合约，我将tx_data单独设置，以验证是否真的是callData缺失导致的问题。
            # tx_data = decode_hex("0x095ea7b300000000000000000000000069460570c93f9de5e2edbc3052bf10125f0ca22d0000000000000000000000000000000000000000000000122af4aaf33e220827")
